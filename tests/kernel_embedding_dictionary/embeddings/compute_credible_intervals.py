...
from test_embeddings import get_config_expquad_lebesgue_1d_1, get_config_expquad_lebesgue_1d_2

embedding_to_config_list_dict = {
    "expquad-lebesgue": [get_config_expquad_lebesgue_1d_1, get_config_expquad_lebesgue_1d_2]
}
...
if __name__ == "__main__":
    ...
    # Choose embedding
    embedding = "expquad-lebesgue"
    get_config_func_list = embedding_to_config_list_dict[embedding]

...
from kernel_embedding_dictionary.kernels import ExpQuadKernel, Matern12Kernel, Matern32Kernel, Matern52Kernel
...
kernel_list = ["expquad", "matern12", "matern32", "matern52"]
